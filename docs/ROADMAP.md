...
| | |
| --- | --- |
| **Goal** | Add a learned scorer as a *configuration change*, and measure whether it is actually better |
...
3. Feature engineering aligned to the *serving* features, to avoid training/serving skew
