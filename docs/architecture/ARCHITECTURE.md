...
| #     | Question                                                                                                                                                                                                                                                                                                                                                                                                                                          | Decide by   |
| ----- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------- |
| ~~1~~ | ~~Should the outbox relay live in `event-worker` or as its own process?~~ **Resolved, Phase 6: co-located.** The relay runs inside `event-worker` alongside the feature-update/case-creation/audit consumers — nothing about this prototype's load justifies a fourth deployable for a poller that shares `event-worker`'s own `coldDb` pool and producer connection. Revisit only if a measured need for independent scaling shows up (Phase 9). | ~~Phase 6~~ |
